...
<script type="text/javascript" charset="utf-8">
	$(document).ready(function(){
		...
		$("#VinculoAddForm").validationEngine();
		...
		<div class="row">
	    	<div class="span8 columns">
				<div class="turmas form">
					<?php echo $this->Form->create('Vinculo', array("class" => "form-stacked"));?>
						<?php
							echo $this->Form->input('vinculo',array("class" => "validate[required]", "label"=> "Vínculo"));
						?>
