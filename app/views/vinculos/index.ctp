	...
	<div class="block_content">
		<div class="row">
			<div class="span8 columns">
				...
				?>
				<tr>
					<td><?php echo $vinculo['Vinculo']['vinculo']; ?>&nbsp;</td>
					<!--
					<td class="actions">
					...
					<?php if($grupo == 1): ?> 
						<?php echo $this->Html->link(
							$this->Html->image('edit.ico',array('alt'=> __('Visualizar pessoas', true),'title'=>'editar', 'border' => '0')),array('action'=>'edit', $vinculo['Vinculo']['id']),array('target' => '_self', 'escape' => false)); ?>

						<?php echo $this->Html->link(
							$this->Html->image('del_btn.png',array('alt'=> __('Deletar pessoas', true),'title'=>'excluir', 'border' => '0')),array('action'=>'delete', $vinculo['Vinculo']['id']),array('target' => '_self', 'escape' => false), sprintf(__('Você tem certeza que deseja apagar essa pessoa?', true), $vinculo['Vinculo']['id'])); ?>
					<?php endif; ?>		
